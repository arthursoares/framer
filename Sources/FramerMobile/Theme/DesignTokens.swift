...
// MARK: - Color Tokens (shared with macOS)
...
enum AppFont {
    ...
    static let sectionHeader = body(11, weight: .semibold)
    static let layerName = body(13, weight: .medium)
    static let controlLabel = body(12)
    static let buttonText = body(13, weight: .semibold)

    static let exifChip = mono(10)
    static let badgeSummary = mono(10)
    static let numericInput = mono(12)
    static let photoCount = mono(11)
}
...
// MARK: - Corner Radius (iOS uses slightly larger radii)
